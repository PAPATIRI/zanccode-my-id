    ...
    @section('hero')
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
                Selamat datang di <span class="text-yellow-500">zanc</span><span class="text-indigo-700">/</span>code 👋
            </h1>
            <p class="text-gray-500 text-lg mt-1">dimana programming terasa menyenangkan</p>
